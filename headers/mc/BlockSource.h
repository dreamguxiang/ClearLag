...
class BlockSource {
  ...
  public:
    ...
    MCINLINE class Block  &getBlock(class BlockPos const &a0) const {
        class Block  &(BlockSource::*rv)(class BlockPos const &) const;
    ...
    MCINLINE class Block  &getBlock(int a0, int a1, int a2) const {
        class Block  &(BlockSource::*rv)(int, int, int) const;
